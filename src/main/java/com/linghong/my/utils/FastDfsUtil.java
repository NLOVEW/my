...
import com.linghong.my.bean.Base64MultipartFile;
import com.linghong.my.bean.FastDfsFile;
...
//        byte[] bytes = InputStream2ByteArray("E:/day62-activiti.zip");
//        FastDfsFile fastDfsFile = new FastDfsFile("测试大文件", bytes,"zip" );
//        fastDfsUtil.uploadImage(fastDfsFile);
    }
